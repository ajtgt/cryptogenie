...
const LandingPage = () => {
  ...
  // console.log("Tokn in LP", token);

  // const userState = useSelector((state) => state.login);
  // console.log(userState?.__raw);
  ...
  // console.log("Plansdata", plansData[0]);
  // console.log("data", user[2]?.id);
      ...
      {!loading && (
        <>
          ...
          <div className="col-sm-6 col-md-3"> */}
            ...
            {/* <PricingCards data={plansData[0]} user={user[1]?.prices[0]?.id} />
              <PricingCards data={plansData[1]} user={user[2]?.prices[0]?.id} />
              <PricingCards data={plansData[2]} user={user[1]?.prices[0]?.id} />
              <PricingCards data={plansData[3]} user={user[2]?.prices[0]?.id} /> */}
            {/* </div> */}
            {/* </div>
        </div> */}
            {/* Cards ^^^*/}
