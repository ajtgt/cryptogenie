...
import YantrakaFooterLogo from "../assets/Footer/YantrakaFooterLogo.svg";

const YantrakaFooter = () => {
  return (
    <div className="container">
      <div className="left-menu d-flex d-sm-flex flex-column flex-sm-row justify-content-center justify-content-sm-between">
        <div className="d-flex  justify-content-center">
          <img src={YantrakaFooterLogo} className="img-fluid" />
        </div>
